...
def main():
    ...
    if evaluation.video == 'all':
        dataset_folder =r"E:\python\project\siamfc-pytorch\mouse"# os.path.join(env.root_dataset, evaluation.dataset)
        ...
        for i in range(nv):
            ...
            for j in range(evaluation.n_subseq):
                ...
                pos_x, pos_y, target_w, target_h = 953, 267, 180, 80  # region_to_bbox(gt[evaluation.start_frame])
                ...
                # lengths[idx], precisions[idx], precisions_auc[idx], ious[idx] = _compile_results(gt, bboxes, evaluation.dist_threshold)
...
def _init_video(env, evaluation, video):
    ...
    video_folder=r"E:\python\project\siamfc-pytorch\mouse/"
    frame_name_list = [video_folder+f for f in os.listdir(video_folder) if f.endswith(".jpg")]
